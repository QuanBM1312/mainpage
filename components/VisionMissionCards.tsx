...
const VisionMissionCards: React.FC = () => {
  return (
    <div className="flex flex-col items-center">
      <section className="box-border flex flex-row max-md:flex-col justify-center gap-8 items-center pt-10 w-full px-4">
        <article className="box-border flex flex-col gap-2.5 justify-center items-center px-1 bg-white rounded-xl border border-teal-600 border-solid w-[564px] max-md:w-full max-md:max-w-[500px]">
          <div className="box-border flex flex-col gap-5 items-start w-[505px] max-sm:w-full">
            ...
            <p className="box-border self-stretch px-4 py-2 text-base leading-6 text-gray-500 max-sm:text-base max-sm:leading-6">
        ...
        <article className="box-border flex flex-col mx-2 gap-2.5 justify-center items-center px-1 bg-white rounded-xl border border-teal-600 border-solid w-[564px] max-md:w-full max-md:max-w-[500px]">
          <div className="box-border flex flex-col gap-5 items-start w-[505px] max-sm:w-full">
            <header className=" box-border flex gap-3.5 items-center pl-3 pt-4">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 shadow-md">
                <img
