...
const HeroSection: React.FC = () => {
  return (
    <section className="box-border overflow-hidden relative p-0 m-0 w-full h-[585px] max-sm:h-[400px]">
      <img
        src="/Hero_background.png"
        alt="Hero background"
        className="box-border object-cover absolute top-0 left-0 p-0 m-0 size-full"
      />
      <div className="box-border flex absolute left-2/4 flex-col gap-1.5 justify-center items-center p-0 m-0 -translate-x-2/4 h-[141px] top-[239px] w-[832px] max-md:max-w-[700px] max-md:w-[90%] max-sm:top-[150px] max-sm:w-[95%]">
