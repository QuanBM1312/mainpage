...
const HeroSection: React.FC = () => {
  return (
    <section className="box-border overflow-hidden relative p-0 m-0 w-full h-[585px] max-sm:h-[500px]">
      ...
      />
      <div className="box-border flex absolute left-2/4 flex-col gap-1.5 justify-center items-center p-0 m-0 -translate-x-2/4 h-[141px] top-[180px] w-[832px] max-md:max-w-[700px] max-md:w-[90%] max-md:w-[90%] max-sm:top-[150px] max-sm:w-[95%]">
      ...
      <p className="box-border absolute left-2/4 p-0 max-md:px-4 text-lg font-medium leading-7 text-center text-gray-500 -translate-x-2/4 h-[52px] top-[350px] w-[540px] max-md:text-base max-md:leading-6 max-md:max-w-[480px] max-md:w-[90%] max-sm:text-sm max-sm:leading-5 max-sm:top-[300px] max-sm:w-[95%]">
